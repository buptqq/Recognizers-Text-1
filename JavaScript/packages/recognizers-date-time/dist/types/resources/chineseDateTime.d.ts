export declare namespace ChineseDateTime {
    ...
    const DatePeriodThisRegex = "这个|这一个|这|这一";
    const DatePeriodLastRegex = "上个|上一个|上|上一";
    const DatePeriodNextRegex = "下个|下一个|下|下一";
    const RelativeMonthRegex: string;
    const DatePeriodYearRegex = "(?<year>19\\d{2}|20\\d{2})年?|(?<year>\\d\\d)年";
    const StrictYearRegex = "(?<year>19\\d{2}|20\\d{2})年?";
    const YearRegexInNumber = "(?<year>19\\d{2}|20\\d{2})";
    ...
    const PastRegex = "(?<past>(前|上|之前))";
    const FutureRegex = "(?<past>(后|下|之后))";
    ...
    const DurationYearRegex = "((19\\d{2}|20\\d{2})|两千)年";
    ...
    const ParserConfigurationBefore = "(前|之前)$";
    const ParserConfigurationAfter = "(后|之后)$";
