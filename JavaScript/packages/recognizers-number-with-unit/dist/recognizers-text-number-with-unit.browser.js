var recognizersTextNumberWithUnit = (function (exports) {
'use strict';
...
class ModelContainer {
    ...
    getModel(modelTypeName, culture$$1, fallbackToDefaultCulture = true) {
        let result = this.tryGetModel(modelTypeName, culture$$1, fallbackToDefaultCulture);
        if (!result.containsModel) {
            throw new Error(`No IModel instance for ${culture$$1}-${modelTypeName}`);
        }
        return result.model;
    }
    tryGetModel(modelTypeName, culture$$1, fallbackToDefaultCulture = true) {
        let ret = true;
        let key = this.generateKey(modelTypeName, culture$$1);
        if (!this.modelInstances.has(key)) {
            if (fallbackToDefaultCulture) {
                culture$$1 = ModelContainer.defaultCulture;
                key = this.generateKey(modelTypeName, culture$$1);
            }
            if (!this.modelInstances.has(key)) {
                ret = false;
            }
    ...
    containsModel(modelTypeName, culture$$1, fallbackToDefaultCulture = true) {
        return this.tryGetModel(modelTypeName, culture$$1, fallbackToDefaultCulture).containsModel;
    }
    registerModel(modelTypeName, culture$$1, model) {
        let key = this.generateKey(modelTypeName, culture$$1);
        if (this.modelInstances.has(key)) {
            throw new Error(`${culture$$1}-${modelTypeName} has been registered.`);
        }
        this.modelInstances.set(key, model);
    }
    registerModels(models, culture$$1) {
        for (let key in models.keys()) {
            let model = models.get(key);
            this.registerModel(key, culture$$1, model);
        }
    }
    generateKey(modelTypeName, culture$$1) {
        return `${culture$$1.toLowerCase()}-${modelTypeName}`;
    }
}
ModelContainer.defaultCulture = culture.Culture.English;
...
class Recognizer {
    constructor() {
        this.modelContainer = new models.ModelContainer();
    }
    ...
    registerModels(models$$1, culture) {
        this.modelContainer.registerModels(models$$1, culture);
    }
}
...
exports.ModelContainer = models.ModelContainer;
...
class EnglishNumberParserConfiguration {
    constructor(ci) {
        ...
        this.signMap = englishNumeric.EnglishNumeric.SignMap;
...
(function (ChineseNumeric) {
    ...
    ChineseNumeric.SignSymbolRegexChs = `[负負]`;
    ChineseNumeric.SignSymbolRegexNum = `(?<![-－])[-－]`;
    ChineseNumeric.SymbolRegex = `^${ChineseNumeric.SignSymbolRegexChs}.*|^${ChineseNumeric.SignSymbolRegexNum}.*`;
    ...
    ChineseNumeric.NumbersSpecialsChars = `(${ChineseNumeric.SignSymbolRegexNum}\\s*)?${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+`;
    ChineseNumeric.NumbersSpecialsCharsWithSuffix = `${ChineseNumeric.SignSymbolRegexNum}?${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+\\s*(K|k|M|G|T|Ｍ|Ｋ|ｋ|Ｇ|Ｔ)`;
    ChineseNumeric.DottedNumbersSpecialsChar = `${ChineseNumeric.SignSymbolRegexNum}?${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}{1,3}([,，]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}{3})+`;
    ...
    ChineseNumeric.AllFloatRegexChs = `${ChineseNumeric.SignSymbolRegexChs}?${ChineseNumeric.AllIntRegexChs}\\s*${ChineseNumeric.PointRegexChsStr}\\s*[一二三四五六七八九零壹贰貳叁肆伍陆陸柒捌玖〇](\\s*${ChineseNumeric.ZeroToNineIntegerRegexChs})*`;
    ChineseNumeric.NumbersWithoutPercent = `(?<![百佰]\\s*分\\s*之\\s*(${ChineseNumeric.AllIntRegexChs}[点點]*|${ChineseNumeric.AllFloatRegexChs})*)${ChineseNumeric.SignSymbolRegexChs}?(${ChineseNumeric.NotSingleRegexChs}|${ChineseNumeric.SingleRegexChs})(?!(${ChineseNumeric.AllIntRegexChs}*([点點]${ChineseNumeric.ZeroToNineIntegerRegexChs}+)*|${ChineseNumeric.AllFloatRegexChs})*\\s*[个個]\\s*[百佰]\\s*分\\s*[点點])`;
    ChineseNumeric.NumbersWithPercent = `(?<![百佰]\\s*分\\s*之\\s*(${ChineseNumeric.AllIntRegexChs}[点點]*|${ChineseNumeric.AllFloatRegexChs})*)${ChineseNumeric.SignSymbolRegexChs}?${ChineseNumeric.AllIntRegexChs}(?!(${ChineseNumeric.AllIntRegexChs}*([点點]${ChineseNumeric.ZeroToNineIntegerRegexChs}+)*|${ChineseNumeric.AllFloatRegexChs})*\\s*[个個]\\s*[百佰]\\s*分\\s*[点點])`;
    ChineseNumeric.PointRegexChs = `${ChineseNumeric.PointRegexChsStr}`;
    ChineseNumeric.DoubleSpecialsChars = `(?<!(${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+[\\.．]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}*))(${ChineseNumeric.SignSymbolRegexNum}\\s*)?${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+[\\.．]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+(?!${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}*[\\.．]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+)`;
    ChineseNumeric.DoubleSpecialsCharsWithNegatives = `(?<!(${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+|\\.\\.|．．))(${ChineseNumeric.SignSymbolRegexNum}\\s*)?[\\.．]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+(?!${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}*([\\.．]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+))`;
    ChineseNumeric.SimpleDoubleSpecialsChars = `(${ChineseNumeric.SignSymbolRegexNum}\\s*)?${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}{1,3}([,，]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}{3})+[\\.．]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+`;
    ChineseNumeric.DoubleWithMultiplierRegex = `(${ChineseNumeric.SignSymbolRegexNum}\\s*)?${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+[\\.．]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+\\s*(K|k|M|G|T|Ｍ|Ｋ|ｋ|Ｇ|Ｔ)`;
    ChineseNumeric.DoubleWithThousandsRegex = `${ChineseNumeric.SignSymbolRegexChs}?${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+([\\.．]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+)?\\s*[多几幾余]?[万亿萬億]{1,2}`;
    ...
    ChineseNumeric.DoubleExponentialNotationRegex = `(?<!${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+[\\.．])(${ChineseNumeric.SignSymbolRegexNum}\\s*)?${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+([\\.．]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+)?e(([-－+＋]*[1-9１２３４５６７８９]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}*)|[0０](?!${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+))`;
    ChineseNumeric.DoubleScientificNotationRegex = `(?<!${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+[\\.．])(${ChineseNumeric.SignSymbolRegexNum}\\s*)?(${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+([\\.．]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+)?)\\^([-－+＋]*[1-9１２３４５６７８９]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}*)`;
    ...
    ChineseNumeric.AllFractionNumber = `${ChineseNumeric.SignSymbolRegexChs}?((${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+|${ChineseNumeric.AllIntRegexChs})\\s*又\\s*)?${ChineseNumeric.SignSymbolRegexChs}?(${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+|${ChineseNumeric.AllIntRegexChs})\\s*分\\s*之\\s*${ChineseNumeric.SignSymbolRegexChs}?(${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+|${ChineseNumeric.AllIntRegexChs})`;
    ChineseNumeric.FractionNotationSpecialsCharsRegex = `(${ChineseNumeric.SignSymbolRegexNum}\\s*)?${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+\\s+${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+[/／]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+`;
    ChineseNumeric.FractionNotationRegex = `(${ChineseNumeric.SignSymbolRegexNum}\\s*)?${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+[/／]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+`;
    ...
    ChineseNumeric.SimpleIntegerPercentageRegex = `${ChineseNumeric.SignSymbolRegexNum}?${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+([\\.．]${ChineseNumeric.ZeroToNineChsFullHalfRegexChs}+)?(\\s*)[％%]`;
...
class ChineseNumberParserConfiguration {
    constructor(ci) {
        ...
        this.symbolRegex = recognizersText.RegExpUtility.getSafeRegExp(chineseNumeric.ChineseNumeric.SymbolRegex, "gis");
...
class EnglishIntegerExtractor extends extractors$4.BaseNumberExtractor {
    constructor(placeholder = englishNumeric.EnglishNumeric.PlaceHolderDefault) {
        ...
        let regexes = new Array({
            ...
            regExp: recognizersText.RegExpUtility.getSafeRegExp(englishNumeric.EnglishNumeric.SignSymbolRegexEng, "gis"),
            value: "IntegerEng"
        });
        this.regexes = regexes;
    }
...
class NumberRecognizer extends recognizersText.Recognizer {
    constructor() {
        super();
        // English models
        this.registerModel("NumberModel", culture$2.Culture.English, new models$2.NumberModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Number, new parserConfiguration.EnglishNumberParserConfiguration()), new extractors$2.EnglishNumberExtractor(models$2.NumberMode.PureNumber)));
        this.registerModel("OrdinalModel", culture$2.Culture.English, new models$2.OrdinalModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Ordinal, new parserConfiguration.EnglishNumberParserConfiguration()), new extractors$2.EnglishOrdinalExtractor()));
        this.registerModel("PercentModel", culture$2.Culture.English, new models$2.PercentModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Percentage, new parserConfiguration.EnglishNumberParserConfiguration()), new extractors$2.EnglishPercentageExtractor()));
        // Spanish models
        this.registerModel("NumberModel", culture$2.Culture.Spanish, new models$2.NumberModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Number, new parserConfiguration$2.SpanishNumberParserConfiguration()), new extractors$6.SpanishNumberExtractor(models$2.NumberMode.PureNumber)));
        this.registerModel("OrdinalModel", culture$2.Culture.Spanish, new models$2.OrdinalModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Ordinal, new parserConfiguration$2.SpanishNumberParserConfiguration()), new extractors$6.SpanishOrdinalExtractor()));
        this.registerModel("PercentModel", culture$2.Culture.Spanish, new models$2.PercentModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Percentage, new parserConfiguration$2.SpanishNumberParserConfiguration()), new extractors$6.SpanishPercentageExtractor()));
        // Portuguese models
        this.registerModel("NumberModel", culture$2.Culture.Portuguese, new models$2.NumberModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Number, new parserConfiguration$4.PortugueseNumberParserConfiguration()), new extractors$8.PortugueseNumberExtractor(models$2.NumberMode.PureNumber)));
        this.registerModel("OrdinalModel", culture$2.Culture.Portuguese, new models$2.OrdinalModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Ordinal, new parserConfiguration$4.PortugueseNumberParserConfiguration()), new extractors$8.PortugueseOrdinalExtractor()));
        this.registerModel("PercentModel", culture$2.Culture.Portuguese, new models$2.PercentModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Percentage, new parserConfiguration$4.PortugueseNumberParserConfiguration()), new extractors$8.PortuguesePercentageExtractor()));
        // Chinese models
        this.registerModel("NumberModel", culture$2.Culture.Chinese, new models$2.NumberModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Number, new parserConfiguration$8.ChineseNumberParserConfiguration()), new extractors$12.ChineseNumberExtractor()));
        this.registerModel("OrdinalModel", culture$2.Culture.Chinese, new models$2.OrdinalModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Ordinal, new parserConfiguration$8.ChineseNumberParserConfiguration()), new extractors$12.ChineseOrdinalExtractor()));
        this.registerModel("PercentModel", culture$2.Culture.Chinese, new models$2.PercentModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Percentage, new parserConfiguration$8.ChineseNumberParserConfiguration()), new extractors$12.ChinesePercentageExtractor()));
        // French models
        this.registerModel("NumberModel", culture$2.Culture.French, new models$2.NumberModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Number, new parserConfiguration$6.FrenchNumberParserConfiguration()), new extractors$10.FrenchNumberExtractor(models$2.NumberMode.PureNumber)));
        this.registerModel("OrdinalModel", culture$2.Culture.French, new models$2.OrdinalModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Ordinal, new parserConfiguration$6.FrenchNumberParserConfiguration()), new extractors$10.FrenchOrdinalExtractor()));
        this.registerModel("PercentModel", culture$2.Culture.French, new models$2.PercentModel(agnosticNumberParser.AgnosticNumberParserFactory.getParser(agnosticNumberParser.AgnosticNumberParserType.Percentage, new parserConfiguration$6.FrenchNumberParserConfiguration()), new extractors$10.FrenchPercentageExtractor()));
    }
...
class NumberWithUnitRecognizer extends recognizersText.Recognizer {
    constructor() {
        super();
        // English models
        this.registerModel("CurrencyModel", recognizersTextNumber.Culture.English, new models$4.CurrencyModel(new Map([
        ...
        this.registerModel("TemperatureModel", recognizersTextNumber.Culture.English, new models$4.TemperatureModel(new Map([
        ...
        this.registerModel("DimensionModel", recognizersTextNumber.Culture.English, new models$4.DimensionModel(new Map([
        ...
        this.registerModel("AgeModel", recognizersTextNumber.Culture.English, new models$4.AgeModel(new Map([
        ...
        // Spanish models
        this.registerModel("CurrencyModel", recognizersTextNumber.Culture.Spanish, new models$4.CurrencyModel(new Map([
        ...
        this.registerModel("TemperatureModel", recognizersTextNumber.Culture.Spanish, new models$4.TemperatureModel(new Map([
        ...
        this.registerModel("DimensionModel", recognizersTextNumber.Culture.Spanish, new models$4.DimensionModel(new Map([
        ...
        this.registerModel("AgeModel", recognizersTextNumber.Culture.Spanish, new models$4.AgeModel(new Map([
        ...
        // Portuguese models
        this.registerModel("CurrencyModel", recognizersTextNumber.Culture.Portuguese, new models$4.CurrencyModel(new Map([
        ...
        this.registerModel("TemperatureModel", recognizersTextNumber.Culture.Portuguese, new models$4.TemperatureModel(new Map([
        ...
        this.registerModel("DimensionModel", recognizersTextNumber.Culture.Portuguese, new models$4.DimensionModel(new Map([
        ...
        this.registerModel("AgeModel", recognizersTextNumber.Culture.Portuguese, new models$4.AgeModel(new Map([
        ...
        // Chinese models
        this.registerModel("CurrencyModel", recognizersTextNumber.Culture.Chinese, new models$4.CurrencyModel(new Map([
        ...
        this.registerModel("TemperatureModel", recognizersTextNumber.Culture.Chinese, new models$4.TemperatureModel(new Map([
        ...
        this.registerModel("DimensionModel", recognizersTextNumber.Culture.Chinese, new models$4.DimensionModel(new Map([
        ...
        this.registerModel("AgeModel", recognizersTextNumber.Culture.Chinese, new models$4.AgeModel(new Map([
        ...
        // French models
        this.registerModel("CurrencyModel", recognizersTextNumber.Culture.French, new models$4.CurrencyModel(new Map([
        ...
        this.registerModel("TemperatureModel", recognizersTextNumber.Culture.French, new models$4.TemperatureModel(new Map([
        ...
        this.registerModel("DimensionModel", recognizersTextNumber.Culture.French, new models$4.DimensionModel(new Map([
        ...
        this.registerModel("AgeModel", recognizersTextNumber.Culture.French, new models$4.AgeModel(new Map([
...
var recognizersTextNumberWithUnit_2 = recognizersTextNumberWithUnit.Culture;
var recognizersTextNumberWithUnit_3 = recognizersTextNumberWithUnit.CultureInfo;
var recognizersTextNumberWithUnit_4 = recognizersTextNumberWithUnit.Constants;
var recognizersTextNumberWithUnit_5 = recognizersTextNumberWithUnit.NumberWithUnitExtractor;
var recognizersTextNumberWithUnit_6 = recognizersTextNumberWithUnit.PrefixUnitResult;
var recognizersTextNumberWithUnit_7 = recognizersTextNumberWithUnit.CompositeEntityType;
var recognizersTextNumberWithUnit_8 = recognizersTextNumberWithUnit.AbstractNumberWithUnitModel;
var recognizersTextNumberWithUnit_9 = recognizersTextNumberWithUnit.AgeModel;
var recognizersTextNumberWithUnit_10 = recognizersTextNumberWithUnit.CurrencyModel;
var recognizersTextNumberWithUnit_11 = recognizersTextNumberWithUnit.DimensionModel;
var recognizersTextNumberWithUnit_12 = recognizersTextNumberWithUnit.TemperatureModel;
var recognizersTextNumberWithUnit_13 = recognizersTextNumberWithUnit.UnitValue;
var recognizersTextNumberWithUnit_14 = recognizersTextNumberWithUnit.NumberWithUnitParser;
var recognizersTextNumberWithUnit_15 = recognizersTextNumberWithUnit.BaseNumberWithUnitParserConfiguration;
var recognizersTextNumberWithUnit_16 = recognizersTextNumberWithUnit.EnglishAgeExtractorConfiguration;
var recognizersTextNumberWithUnit_17 = recognizersTextNumberWithUnit.EnglishAgeParserConfiguration;
var recognizersTextNumberWithUnit_18 = recognizersTextNumberWithUnit.EnglishNumberWithUnitExtractorConfiguration;
var recognizersTextNumberWithUnit_19 = recognizersTextNumberWithUnit.EnglishNumberWithUnitParserConfiguration;
var recognizersTextNumberWithUnit_20 = recognizersTextNumberWithUnit.EnglishCurrencyExtractorConfiguration;
var recognizersTextNumberWithUnit_21 = recognizersTextNumberWithUnit.EnglishCurrencyParserConfiguration;
var recognizersTextNumberWithUnit_22 = recognizersTextNumberWithUnit.EnglishDimensionExtractorConfiguration;
var recognizersTextNumberWithUnit_23 = recognizersTextNumberWithUnit.EnglishDimensionParserConfiguration;
var recognizersTextNumberWithUnit_24 = recognizersTextNumberWithUnit.EnglishTemperatureExtractorConfiguration;
var recognizersTextNumberWithUnit_25 = recognizersTextNumberWithUnit.EnglishTemperatureParserConfiguration;
var recognizersTextNumberWithUnit_26 = recognizersTextNumberWithUnit.SpanishAgeExtractorConfiguration;
var recognizersTextNumberWithUnit_27 = recognizersTextNumberWithUnit.SpanishAgeParserConfiguration;
var recognizersTextNumberWithUnit_28 = recognizersTextNumberWithUnit.SpanishNumberWithUnitExtractorConfiguration;
var recognizersTextNumberWithUnit_29 = recognizersTextNumberWithUnit.SpanishNumberWithUnitParserConfiguration;
var recognizersTextNumberWithUnit_30 = recognizersTextNumberWithUnit.SpanishCurrencyExtractorConfiguration;
var recognizersTextNumberWithUnit_31 = recognizersTextNumberWithUnit.SpanishCurrencyParserConfiguration;
var recognizersTextNumberWithUnit_32 = recognizersTextNumberWithUnit.SpanishDimensionExtractorConfiguration;
var recognizersTextNumberWithUnit_33 = recognizersTextNumberWithUnit.SpanishDimensionParserConfiguration;
var recognizersTextNumberWithUnit_34 = recognizersTextNumberWithUnit.SpanishTemperatureExtractorConfiguration;
var recognizersTextNumberWithUnit_35 = recognizersTextNumberWithUnit.SpanishTemperatureParserConfiguration;
var recognizersTextNumberWithUnit_36 = recognizersTextNumberWithUnit.PortugueseAgeExtractorConfiguration;
var recognizersTextNumberWithUnit_37 = recognizersTextNumberWithUnit.PortugueseAgeParserConfiguration;
var recognizersTextNumberWithUnit_38 = recognizersTextNumberWithUnit.PortugueseNumberWithUnitExtractorConfiguration;
var recognizersTextNumberWithUnit_39 = recognizersTextNumberWithUnit.PortugueseNumberWithUnitParserConfiguration;
var recognizersTextNumberWithUnit_40 = recognizersTextNumberWithUnit.PortugueseCurrencyExtractorConfiguration;
var recognizersTextNumberWithUnit_41 = recognizersTextNumberWithUnit.PortugueseCurrencyParserConfiguration;
var recognizersTextNumberWithUnit_42 = recognizersTextNumberWithUnit.PortugueseDimensionExtractorConfiguration;
var recognizersTextNumberWithUnit_43 = recognizersTextNumberWithUnit.PortugueseDimensionParserConfiguration;
var recognizersTextNumberWithUnit_44 = recognizersTextNumberWithUnit.PortugueseTemperatureExtractorConfiguration;
var recognizersTextNumberWithUnit_45 = recognizersTextNumberWithUnit.PortugueseTemperatureParserConfiguration;
var recognizersTextNumberWithUnit_46 = recognizersTextNumberWithUnit.ChineseAgeExtractorConfiguration;
var recognizersTextNumberWithUnit_47 = recognizersTextNumberWithUnit.ChineseAgeParserConfiguration;
var recognizersTextNumberWithUnit_48 = recognizersTextNumberWithUnit.ChineseNumberWithUnitExtractorConfiguration;
var recognizersTextNumberWithUnit_49 = recognizersTextNumberWithUnit.ChineseNumberWithUnitParserConfiguration;
var recognizersTextNumberWithUnit_50 = recognizersTextNumberWithUnit.ChineseCurrencyExtractorConfiguration;
var recognizersTextNumberWithUnit_51 = recognizersTextNumberWithUnit.ChineseCurrencyParserConfiguration;
var recognizersTextNumberWithUnit_52 = recognizersTextNumberWithUnit.ChineseDimensionExtractorConfiguration;
var recognizersTextNumberWithUnit_53 = recognizersTextNumberWithUnit.ChineseDimensionParserConfiguration;
var recognizersTextNumberWithUnit_54 = recognizersTextNumberWithUnit.ChineseTemperatureExtractorConfiguration;
var recognizersTextNumberWithUnit_55 = recognizersTextNumberWithUnit.ChineseTemperatureParserConfiguration;
var recognizersTextNumberWithUnit_56 = recognizersTextNumberWithUnit.EnglishNumericWithUnit;
var recognizersTextNumberWithUnit_57 = recognizersTextNumberWithUnit.SpanishNumericWithUnit;
var recognizersTextNumberWithUnit_58 = recognizersTextNumberWithUnit.PortugueseNumericWithUnit;
var recognizersTextNumberWithUnit_59 = recognizersTextNumberWithUnit.ChineseNumericWithUnit;

exports['default'] = recognizersTextNumberWithUnit$1;
exports.NumberWithUnitRecognizer = recognizersTextNumberWithUnit_1;
exports.Culture = recognizersTextNumberWithUnit_2;
exports.CultureInfo = recognizersTextNumberWithUnit_3;
exports.Constants = recognizersTextNumberWithUnit_4;
exports.NumberWithUnitExtractor = recognizersTextNumberWithUnit_5;
exports.PrefixUnitResult = recognizersTextNumberWithUnit_6;
exports.CompositeEntityType = recognizersTextNumberWithUnit_7;
exports.AbstractNumberWithUnitModel = recognizersTextNumberWithUnit_8;
exports.AgeModel = recognizersTextNumberWithUnit_9;
exports.CurrencyModel = recognizersTextNumberWithUnit_10;
exports.DimensionModel = recognizersTextNumberWithUnit_11;
exports.TemperatureModel = recognizersTextNumberWithUnit_12;
exports.UnitValue = recognizersTextNumberWithUnit_13;
exports.NumberWithUnitParser = recognizersTextNumberWithUnit_14;
exports.BaseNumberWithUnitParserConfiguration = recognizersTextNumberWithUnit_15;
exports.EnglishAgeExtractorConfiguration = recognizersTextNumberWithUnit_16;
exports.EnglishAgeParserConfiguration = recognizersTextNumberWithUnit_17;
exports.EnglishNumberWithUnitExtractorConfiguration = recognizersTextNumberWithUnit_18;
exports.EnglishNumberWithUnitParserConfiguration = recognizersTextNumberWithUnit_19;
exports.EnglishCurrencyExtractorConfiguration = recognizersTextNumberWithUnit_20;
exports.EnglishCurrencyParserConfiguration = recognizersTextNumberWithUnit_21;
exports.EnglishDimensionExtractorConfiguration = recognizersTextNumberWithUnit_22;
exports.EnglishDimensionParserConfiguration = recognizersTextNumberWithUnit_23;
exports.EnglishTemperatureExtractorConfiguration = recognizersTextNumberWithUnit_24;
exports.EnglishTemperatureParserConfiguration = recognizersTextNumberWithUnit_25;
exports.SpanishAgeExtractorConfiguration = recognizersTextNumberWithUnit_26;
exports.SpanishAgeParserConfiguration = recognizersTextNumberWithUnit_27;
exports.SpanishNumberWithUnitExtractorConfiguration = recognizersTextNumberWithUnit_28;
exports.SpanishNumberWithUnitParserConfiguration = recognizersTextNumberWithUnit_29;
exports.SpanishCurrencyExtractorConfiguration = recognizersTextNumberWithUnit_30;
exports.SpanishCurrencyParserConfiguration = recognizersTextNumberWithUnit_31;
exports.SpanishDimensionExtractorConfiguration = recognizersTextNumberWithUnit_32;
exports.SpanishDimensionParserConfiguration = recognizersTextNumberWithUnit_33;
exports.SpanishTemperatureExtractorConfiguration = recognizersTextNumberWithUnit_34;
exports.SpanishTemperatureParserConfiguration = recognizersTextNumberWithUnit_35;
exports.PortugueseAgeExtractorConfiguration = recognizersTextNumberWithUnit_36;
exports.PortugueseAgeParserConfiguration = recognizersTextNumberWithUnit_37;
exports.PortugueseNumberWithUnitExtractorConfiguration = recognizersTextNumberWithUnit_38;
exports.PortugueseNumberWithUnitParserConfiguration = recognizersTextNumberWithUnit_39;
exports.PortugueseCurrencyExtractorConfiguration = recognizersTextNumberWithUnit_40;
exports.PortugueseCurrencyParserConfiguration = recognizersTextNumberWithUnit_41;
exports.PortugueseDimensionExtractorConfiguration = recognizersTextNumberWithUnit_42;
exports.PortugueseDimensionParserConfiguration = recognizersTextNumberWithUnit_43;
exports.PortugueseTemperatureExtractorConfiguration = recognizersTextNumberWithUnit_44;
exports.PortugueseTemperatureParserConfiguration = recognizersTextNumberWithUnit_45;
exports.ChineseAgeExtractorConfiguration = recognizersTextNumberWithUnit_46;
exports.ChineseAgeParserConfiguration = recognizersTextNumberWithUnit_47;
exports.ChineseNumberWithUnitExtractorConfiguration = recognizersTextNumberWithUnit_48;
exports.ChineseNumberWithUnitParserConfiguration = recognizersTextNumberWithUnit_49;
exports.ChineseCurrencyExtractorConfiguration = recognizersTextNumberWithUnit_50;
exports.ChineseCurrencyParserConfiguration = recognizersTextNumberWithUnit_51;
exports.ChineseDimensionExtractorConfiguration = recognizersTextNumberWithUnit_52;
exports.ChineseDimensionParserConfiguration = recognizersTextNumberWithUnit_53;
exports.ChineseTemperatureExtractorConfiguration = recognizersTextNumberWithUnit_54;
exports.ChineseTemperatureParserConfiguration = recognizersTextNumberWithUnit_55;
exports.EnglishNumericWithUnit = recognizersTextNumberWithUnit_56;
exports.SpanishNumericWithUnit = recognizersTextNumberWithUnit_57;
exports.PortugueseNumericWithUnit = recognizersTextNumberWithUnit_58;
exports.ChineseNumericWithUnit = recognizersTextNumberWithUnit_59;
