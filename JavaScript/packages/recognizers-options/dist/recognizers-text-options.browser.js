var recognizersTextOptions = (function (exports) {
'use strict';
...
class OptionsExtractor {
    ...
    tokenize(source) {
        return recognizersText.RegExpUtility.split(this.config.tokenRegex, source).filter(s => !recognizersText.StringUtility.isNullOrWhitespace(s));
    }
}
...
var englishOptions = createCommonjsModule(function (module, exports) {
"use strict";
// ------------------------------------------------------------------------------
// <auto-generated>
...
class EnglishBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.regexTrue = recognizersText.RegExpUtility.getSafeRegExp(englishOptions.EnglishOptions.TrueRegex);
        this.regexFalse = recognizersText.RegExpUtility.getSafeRegExp(englishOptions.EnglishOptions.FalseRegex);
        this.tokenRegex = recognizersText.RegExpUtility.getSafeRegExp(englishOptions.EnglishOptions.TokenizerRegex);
...
var optionsRecognizer = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class OptionsRecognizer extends recognizersText.Recognizer {
    constructor() {
        super();
        // English models
        this.registerModel("BooleanModel", recognizersText.Culture.English, new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1.EnglishBooleanExtractorConfiguration())));
    }
...
unwrapExports(optionsRecognizer);

var recognizersTextOptions = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });

exports.OptionsRecognizer = optionsRecognizer.default;

exports.Culture = recognizersText.Culture;

exports.OptionsModel = models$2.OptionsModel;
exports.BooleanModel = models$2.BooleanModel;

exports.OptionsExtractor = extractors$2.OptionsExtractor;
exports.BooleanExtractor = extractors$2.BooleanExtractor;

exports.OptionsParser = parsers$2.OptionsParser;
...
exports.EnglishOptions = englishOptions.EnglishOptions;

});

var recognizersTextOptions$1 = unwrapExports(recognizersTextOptions);
var recognizersTextOptions_1 = recognizersTextOptions.OptionsRecognizer;
var recognizersTextOptions_2 = recognizersTextOptions.Culture;
var recognizersTextOptions_3 = recognizersTextOptions.OptionsModel;
var recognizersTextOptions_4 = recognizersTextOptions.BooleanModel;
var recognizersTextOptions_5 = recognizersTextOptions.OptionsExtractor;
var recognizersTextOptions_6 = recognizersTextOptions.BooleanExtractor;
var recognizersTextOptions_7 = recognizersTextOptions.OptionsParser;
var recognizersTextOptions_8 = recognizersTextOptions.BooleanParser;
var recognizersTextOptions_9 = recognizersTextOptions.EnglishBooleanExtractorConfiguration;
var recognizersTextOptions_10 = recognizersTextOptions.EnglishOptions;

exports['default'] = recognizersTextOptions$1;
exports.OptionsRecognizer = recognizersTextOptions_1;
exports.Culture = recognizersTextOptions_2;
exports.OptionsModel = recognizersTextOptions_3;
exports.BooleanModel = recognizersTextOptions_4;
exports.OptionsExtractor = recognizersTextOptions_5;
exports.BooleanExtractor = recognizersTextOptions_6;
exports.OptionsParser = recognizersTextOptions_7;
exports.BooleanParser = recognizersTextOptions_8;
exports.EnglishBooleanExtractorConfiguration = recognizersTextOptions_9;
exports.EnglishOptions = recognizersTextOptions_10;

return exports;

}({}));
//# sourceMappingURL=recognizers-text-options.browser.js.map
